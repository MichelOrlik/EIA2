...
(function (L05_Server) {
    ...
    let server = Http.createServer(); // Variable "server" vom Typ Http.Server erstellen und dieser Variable wird die Funktion createServer() aus dem importierten Code zugewiesen
