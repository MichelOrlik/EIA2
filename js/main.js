...
function helloworld() {
    var person = prompt("Enter name for free Shrek 2 DVD", "Your name"); /* So wird ein prompt erstellt, wie ich aus w3schools erfahren habe */
    var hola = person + "! Was geht ab?"; /* Erstelle eine neue Variabel die den Satz enthält */
