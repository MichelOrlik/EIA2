...
function init() {
    ...
    function welsm(_x: number, _y: number): void {
    ...
    function welsw(_x: number, _y: number): void {
        c.fillStyle = 'rgb(169,169,169)';
        c.beginPath(); // Saugmund
        c.moveTo(_x + 50, _y + 50);
        c.lineTo(_x + 80, _y + 50);
    ...
    function fischFroehlich(_x: number, _y: number): void {
    ...
    function fischNeutral(_x: number, _y: number): void {
        c.fillStyle = 'rgba(235, 151, 78, 1)';
    ...
    function fischTraurig(_x: number, _y: number): void {
        c.strokeStyle = 'rgb(0,0,0)';
        c.beginPath(); // Kaudale Flosse
        c.moveTo(_x + 50, _y + 50);
        c.lineTo(_x + 50, _y + 80);
    ...
    function luftblase(_x: number, _y: number): void {
        c.beginPath();
